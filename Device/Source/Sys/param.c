...
//	sprintf((char *)cfg->WiFiCfg.Ssid, "nuap%02x%02x%02x", PermanentAddress[3], PermanentAddress[4], PermanentAddress[5]); 
	sprintf((char *)cfg->WiFiCfg.Ssid, "NuAgent-%02x%02x%02x%02x", PermanentAddress[2], PermanentAddress[3], PermanentAddress[4], PermanentAddress[5]); 
	...
	cfg->WiFiCfg.Encry = 3;			//0-none 1--wep 2--tkip  3--ccmp 4--auto
	cfg->WiFiCfg.AuthMode = 3;			//0-open 1--wep 2--wpa1  3--wpa2
	cfg->WiFiCfg.Protocol = 2;			//0-sta 1-adhoc 2-softap
	cfg->WiFiCfg.KeyIndex = 0;
	sprintf((char *)cfg->WiFiCfg.PSK, "123456789");
	cfg->WiFiCfg.KeyLength = strlen("123456789");
	...
	cfg->IPCfg.GateWay[0] = 10;
	cfg->IPCfg.GateWay[1] = 10;
	cfg->IPCfg.GateWay[2] = 100;
	cfg->IPCfg.GateWay[3] = 254;
	cfg->IPCfg.Dns[0] = 10;
	cfg->IPCfg.Dns[1] = 10;
	cfg->IPCfg.Dns[2] = 100;
	cfg->IPCfg.Dns[3] = 254;
