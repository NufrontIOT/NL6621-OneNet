...
#define MEMP_NUM_SYS_TIMEOUT    8 // pengchaonan modify, 5->8 for resolve #error "MEMP_NUM_SYS_TIMEOUT is too low to accomodate all required timeouts"
...
#define LWIP_RAND()				GetRandomWord()
#endif
